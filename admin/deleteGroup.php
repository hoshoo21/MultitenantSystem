...
if( $groupID = $_GET['groupID'] ) {
	try {
		$deleteGroupParam = array('groupID' => $groupID);
		$deleteGroupResult = $client->deleteGroup($deleteGroupParam);
		$deleteGroupResult = $deleteGroupResult->OK;
		echo "Delete Group result is $deleteGroupResult<br><br>";
	} catch (SoapFault $e) {
