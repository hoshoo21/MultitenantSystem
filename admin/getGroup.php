...
if( $groupID = $_GET['groupID'] ) {
	...
	try {
		...
		echo "groupID is $group->groupID<br>";
		echo "name is $group->name<br>";
		echo "roomMaxUsers is $group->roomMaxUsers<br>";
		echo "userMaxBandWidthIn is $group->userMaxBandWidthIn<br>";
		echo "userMaxBandWidthOut is $group->userMaxBandWidthOut<br>";
		echo "description is $group->description<br>";
		echo "primaryVRPool is $group->primaryVRPool<br>";
		echo "secondaryVRPool is $group->secondaryVRPool<br>";
		echo "<br>";
	} catch (SoapFault $e) {
