...
// prepare delete member
if( $memberID = $_GET['memberID'] ) {
	try {
		$deleteMemberParam = array('memberID' => $memberID);
		$deleteMemberResult = $client->deleteMember($deleteMemberParam);
		$deleteMemberResult = $deleteMemberResult->OK;
		echo "Delete Member result is $deleteMemberResult<br><br>";
	} catch (SoapFault $e) {
