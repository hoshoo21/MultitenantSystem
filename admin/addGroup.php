...
if( $groupID = $_GET['groupID'] ) $group['groupID'] = $groupID;
...
try {
	$addGroupParam = array('group' => $group);
	$addGroupResult = $client->addGroup($addGroupParam);
	$addGroupResult = $addGroupResult->OK;
	echo "Add Group result is $addGroupResult<br><br>";
} catch (SoapFault $e) {
